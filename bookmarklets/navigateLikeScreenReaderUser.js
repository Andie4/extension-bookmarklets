    ...
    function navigateLikeSR() {
        ...
        let i = {
                isElementHidden: function e(t) {
                    ...
                    return "none" === o.display || "hidden" === o.visibility || !!t.parentElement && e(t.parentElement)
                },
                isElementVisuallyHidden: function e(t) {
                    ...
                    return Object.entries({
                        ...
                        position: "absolute",
                        width: "1px"
                    }).every(([e, t]) => o.getPropertyValue(e) === t)
                },
                getTextContent: function e(t) {
                    function o(e) {
                        let t = function e(t) {
                            ...
                            if (t.hasAttribute("aria-labelledby")) {
                                let o = t.getAttribute("aria-labelledby").split(" ");
                        ...
                        switch (e.nodeName.toLowerCase()) {
                            case "img":
                                return e.getAttribute("alt") || e.getAttribute("title") || "";
                            case "svg":
                                let o = e.querySelector("title"),
                                    l = e.querySelector("desc");
                                return [o ? o.textContent : "", l ? l.textContent : "", e.getAttribute("aria-label") || ""].filter(e => e.length > 0).join(" ");
                            default:
                                return ""
                        }
                    }
                    return (function e(t) {
                        ...
                        if (t.nodeType === Node.ELEMENT_NODE) {
                            if ("svg" === t.nodeName.toLowerCase()) return o(t);
                            let a = o(t);
                            for (let r of (a && (l += a + " "), t.childNodes)) l += e(r) + " "
                        }
                        return l.trim()
                    })(t).replace(/\s+/g, " ").trim()
                },
                computeAccessibleName: function e(t) {
                    ...
                    function l(e) {
                        let t = "";
                        for (let a of e.childNodes) a.nodeType === Node.TEXT_NODE ? t += a.textContent.trim() : a.nodeType !== Node.ELEMENT_NODE || o(a) || (t += l(a));
                        return t
                    }
                    let a = t.getAttribute("aria-labelledby");
                    if (a) {
                        var r;
                        let n = (r = a) ? r.split(/\s+/).map(e => document.getElementById(e)).filter(e => null !== e) : [];
                        if (n.length > 0) return n.map(t => e(t)).filter(e => e.length > 0).join(" ")
                    }
                ...
                prepareElement: (e, t, o) => (e.classList.add("a11y-tools-focus-highlight"), e.getAttribute("id") || e.setAttribute("id", `${t}${o}`), e.getAttribute("id")),
                createListItem(e, t, o) {
                    let l = `<li><a data-source=${t} href="#${e}">${o}`;
                    return this.isElementVisuallyHidden(document.getElementById(t)) && (l += " (WARNING: visually hidden element)"), l + "</a></li>"
                },
                wrapInList(e, t = "") {
                    let o = `<ul>${e}</ul>`;
                    return t && (o += `<p>${t}</p>`), o
        ...
        function d() {
            ...
            let t = document.querySelectorAll(s.formControls),
                o = document.querySelector("[name=levelOfDetail]:checked").getAttribute("id");
            Array.from(t).forEach((t, l) => {
                if (!i.isElementHidden(t)) {
                    r++;
                    let a = i.prepareElement(t, "formEl", l + 1),
                        n = t.tagName.toLowerCase(),
                        s = t.getAttribute("name"),
                        d = i.computeAccessibleName(t),
                        c = function e(t) {
                            let o = t.tagName.toLowerCase(),
                                l = t.getAttribute("type")?.toLowerCase();
                            if ("input" === o) switch (l) {
                                    case "text":
                                    default:
                                        return "textbox";
                                    ...
                                    case "week":
                                        return "week picker"
                                } else if ("textarea" === o) return "multiline textbox";
                                else if ("select" === o) return t.hasAttribute("multiple") ? "multi-select list" : "dropdown";
                            else if ("button" === o || "button" === t.getAttribute("role")) return "button";
                            return "form control"
                        }(t),
                        u = d ? `"${d}" ` : "*MISSING LABEL*";
                    u += `<span aria-hidden="false">, ${c}</span>`, "DetailedView" === o && (u += ` <span aria-hidden="false">(${n}${a?`, id: ${a}`:""}${s?`, name: ${s}`:""})</span>`), e += i.createListItem(a, a, u)
                }
            }), document.querySelector("#tabPanel4 .tabpanel-inner").innerHTML = i.wrapInList(e)
        }
        ...
        function c() {
            document.querySelector(".a11y-tools-modal") ? (t.classList.add("a11y-tools-modal-open"), document.querySelector("#a11y-tools-hint-panel") && document.querySelector("#a11y-tools-hint-panel").remove()) : (function e() {
                ...
                o.className = "a11y-tools-modal-content";
                ...
                o.innerHTML = l, t.appendChild(o);
                let a = document.createElement("button");
                a.textContent = "\xd7", a.className = "a11y-tools-modal-close", a.setAttribute("aria-label", "Close dialog"), o.insertBefore(a, o.firstChild), a.addEventListener("click", () => {
                    u()
                }), t.classList.add("a11y-tools-modal-open"), document.body.appendChild(t), t.querySelector("a[role=tab]").focus()
            }(), function e() {
                function t(e, t, o) {
                    l = e, a = t, Array.from(l).forEach(e => {
                        e.setAttribute("hidden", "hidden")
                    }), Array.from(a).forEach(e => {
                        e.removeAttribute("aria-selected")
                    }), o.setAttribute("aria-selected", "true");
                    var l, a, r = o.getAttribute("aria-controls");
                    document.querySelector("#" + r).removeAttribute("hidden")
                }
                document.querySelector("body").classList.add("js"), Array.from(document.querySelectorAll(".a11y-tools-tabs")).forEach(e => {
                    ...
                    var o = e.querySelectorAll("[role=tab]"),
                        l = e.querySelectorAll("[role=tabpanel]"),
                        a = e.querySelector("[role=tab]"),
                        r = e.querySelector("[role=tabpanel]");
                    Array.from(o).forEach(e => {
                        e.addEventListener("click", a => {
                            t(l, o, e), a.preventDefault()
                        }), e.addEventListener("focus", a => {
                            t(l, o, e)
                        })
                    }), Array.from(l).forEach(e => {
                        e.setAttribute("hidden", "hidden")
                    }), a.setAttribute("aria-selected", "true"), r.removeAttribute("hidden")
                })
            }(), function e() {
                let t = !1,
                    l = "";
                ...
                Array.from(a).forEach((e, a) => {
                    if (!i.isElementHidden(e)) {
                        o++;
                        let r = function e(t, o) {
                            let l = t.tagName.toLowerCase(),
                                a = {
                                    complementary: "aside",
                                    contentinfo: "footer",
                                    banner: "header",
                                ...
                                n = r && a[r];
                            n && (l = a[r]);
                            let s = t.getAttribute("aria-label") || (t.getAttribute("aria-labelledby") ? i.computeAccessibleName(t) : ""),
                                d = i.prepareElement(t, "landmark", o),
                                c = `${l}${s?` (${s})`:""}`;
                            return {
                                html: i.createListItem(d, d, c),
                                convertedBack: n
                            }
                        }(e, a + 1);
                        l += r.html, t = t || r.convertedBack, e.getAttribute("tabindex") || e.setAttribute("tabindex", "-1")
                    }
                });
                let r = t ? "Note: some landmarks were defined using <code>role</code> attributes but are indicated by their native HTML equivalents for simplicity." : "";
                document.querySelector("#tabPanel1 .tabpanel-inner").innerHTML = i.wrapInList(l, r)
            }(), function e() {
                let t = "";
                l = 0;
                let o = document.querySelectorAll(s.headings);
                Array.from(o).forEach((e, o) => {
                    i.isElementHidden(e) || (l++, t += function e(t, o) {
                        let l = {
                                h1: {
                                    level: "H1",
                            ...
                            a, r, n = t.tagName.toLowerCase(),
                            s = t.getAttribute("aria-level");
                        if ("heading" === t.getAttribute("role") && s) {
                            let d = l[`h${s}`];
                            a = d.level, r = d.announcement
                        } else a = l[n].level, r = l[n].announcement;
                        let c = i.prepareElement(t, "heading", o),
                            u = i.getTextContent(t) || "*MISSING LABEL*",
                            b = `${u}<span class="visually-hidden">${r}</span><span class="pill" aria-hidden="true">${a}</span>`;
                        return i.createListItem(c, c, b)
                    }(e, o + 1))
                }), document.querySelector("#tabPanel2 .tabpanel-inner").innerHTML = i.wrapInList(t)
            }(), function e() {
                let t = "";
                a = 0;
                let o = document.querySelectorAll(s.links);
                Array.from(o).forEach((e, o) => {
                    if (!i.isElementHidden(e)) {
                        a++;
                        let l = i.prepareElement(e, "link", o + 1),
                            r = i.getTextContent(e);
                        "" === r && (r = "*MISSING LABEL*"), t += i.createListItem(e.href, l, r)
                    }
                });
                let l = document.querySelector("#tabPanel3 .tabpanel-inner");
                l.innerHTML = i.wrapInList(t);
                let r = l.querySelectorAll("li a");
                Array.from(r).forEach(e => {
                    e.addEventListener("click", t => {
                        let o = document.querySelector("[name=linkBehaviour]:checked").getAttribute("id");
                        "radLinkImmediately" !== o && (t.preventDefault(), document.querySelector("#" + e.getAttribute("data-source")).focus())
                    })
                })
            }(), d(), function e() {
            ...
            }(), document.querySelector("#tab1").innerHTML = 'Landmarks <span class="pill">' + o + "</span>", document.querySelector("#tab2").innerHTML = 'Headings <span class="pill">' + l + "</span>", document.querySelector("#tab3").innerHTML = 'Links <span class="pill">' + a + "</span>", document.querySelector("#tab4").innerHTML = 'Form Controls <span class="pill">' + r + "</span>", t = document.querySelector(".a11y-tools-modal")), document.querySelector(".a11y-tools-modal a[role=tab]").focus()
        }
        ...
        document.addEventListener("keydown", function(e) {
                "Escape" === e.key && u(), "N" === e.key && e.shiftKey && (e.preventDefault(), c()), ("ArrowLeft" === e.key || "ArrowRight" === e.key) && document.querySelector(".a11y-tools-modal.a11y-tools-modal-open") && function e(t) {
                    let o = document.querySelector('.a11y-tools-modal [role="tablist"]'),
                        l = Array.from(o.querySelectorAll('[role="tab"]')),
                        a = document.querySelector('[aria-selected="true"]');
                    if (Array.from(l).forEach(e => {
                            e.setAttribute("tabindex", "-1")
                        }), !a) return;
                    let r = l.indexOf(a),
                        n;
                    if ("ArrowLeft" === t.key) n = 0 === r ? l.length - 1 : r - 1, t.preventDefault();
                    else {
                        if ("ArrowRight" !== t.key) return;
                        n = r === l.length - 1 ? 0 : r + 1, t.preventDefault()
                    }
                    l[n].click(), l[n].focus(), l[n].removeAttribute("tabindex")
                }(e)
            }), c(),
            function e() {
                function t(e) {
                ...
                let o = document.querySelectorAll(".tabpanel-inner li a");
                Array.from(o).forEach(e => {
